...
GUNICORN_CONF_PATH = os.path.join(get_root_path(), "gunicorn_conf.py")

APP_PATH = os.path.join(os.path.expanduser("~"), "Program", "data_analysis_with_agent")
...
_SUBMOD_ATTRS = {
    "backend": [
        "start_data_analysis_with_agent",
        "stop_data_analysis_with_agent",
    ],
}
...
if TYPE_CHECKING:  # pragma: no cover
    from .backend import (
        start_data_analysis_with_agent,  # noqa: F401
        stop_data_analysis_with_agent,  # noqa: F401
    )
